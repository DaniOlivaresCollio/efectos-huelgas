...
\hypertarget{exploraciuxf3n-y-preparaciuxf3n-de-datos}{%
\chapter{Exploración y preparación de datos}\label{exploraciuxf3n-y-preparaciuxf3n-de-datos}}
...
\hypertarget{full-time}{%
\subsection{Full-time}\label{full-time}}

Se crea una nueva variable binaria llamada \emph{full-time} para identificar a aquellas personas que:
...
Frecuencias y porcentajes de Trabajadores/as con jornada completa, por ola
...
Recodificación con paquete \texttt{occupar}, ver el \href{https://github.com/DiogoFerrari/occupar}{enlace}.
...
\tightlist
\item
  Se unen \emph{B} y \emph{C}
\item
  Se unen \emph{D}, \emph{E} y \emph{F}
\item
  Se unen \emph{G} y \emph{I}
\item
  Se unen \emph{J}, \emph{K}, \emph{L}, \emph{M} y \emph{N}
\item
  Se unen \emph{P} y \emph{Q}
\item
  Se unen \emph{R}, \emph{S} y \emph{U}
\end{itemize}

Frecuencias y porcentajes de la Rama 2, por ola
...
\item
  Self-employed
\item
  Expert managers: expertos que supervisan
\item
  Experts: expertos que no supervisan
\item
  Skilled supervisors: skilled que supervisan
\item
  Skilled workers: skilled que no supervisan
\item
  Unskilled supervisors: unskilled que supervisan
\item
  Workers: skilled que no supervisan
\end{enumerate}
...
\tightlist
\item
  Se unen \emph{Skilled supervisors} y \emph{Unskilled supervisors}
\item
  Se unen \emph{Skilled workers} y \emph{Workers}
\end{itemize}

Frecuencias y porcentajes de la Posición de clase 2, por ola
...
Se crea una nueva variable binaria llamada \emph{open-ended} para identificar a aquellas personas que:
...
Frecuencias y porcentajes de Trabajadores/as permanentes, por ola
...
\hypertarget{female}{%
\subsection{Female}\label{female}}

Se crea una nueva variable binaria llamada \emph{female} para identificar a aquellas personas que:
...
Frecuencias y porcentajes de Trabajadoras, por ola
...
\caption{\label{tab:unnamed-chunk-20}Frecuencia de respuestas 'Movimiento social de apoyo a demandas laborales'}
\centering
...
\caption{\label{tab:unnamed-chunk-24}Frecuencias de 'Grado de acuerdo: Posición opuesta entre el movimiento y las autoridades' por ola}
\centering
...
\caption{\label{tab:unnamed-chunk-25}Frecuencias de 'Frecuencia: Participación en el movimiento' por ola}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
...
\caption{\label{tab:unnamed-chunk-26}Frecuencias de cada categoría de Membresía Sindicatos por ola considerando toda la muestra}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
...
\caption{\label{tab:unnamed-chunk-27}Frecuencias de Membresía Sindicato por ola, para quienes valoran movimientos laborales}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
mem\_sindicato & Ola\_1 & Ola\_3 & Ola\_5\\
...
\caption{\label{tab:unnamed-chunk-28}Frecuencias de cada categoría de Participación en huelga por ola considerando toda la muestra}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
...
\caption{\label{tab:unnamed-chunk-29}Frecuencias de Participación en huelga por ola, para quienes valoran movimientos laborales}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
part\_huelga & Ola\_1 & Ola\_3 & Ola\_5\\
...
\caption{\label{tab:unnamed-chunk-30}Frecuencias de Participación en huelga por ola, para quienes son miembros de sindicatos (activos o inactivos)}
\centering
...
\caption{\label{tab:unnamed-chunk-31}Frecuencias de cada categoría de Interés en la política por ola considerando toda la muestra}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
...
\caption{\label{tab:unnamed-chunk-32}Frecuencias de Interés en la política por ola, para quienes valoran movimientos laborales}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
int\_politica & Ola\_1 & Ola\_3 & Ola\_5\\
...
\caption{\label{tab:unnamed-chunk-33}Frecuencias de Interés en la política por ola, para quienes son miembros de sindicatos (activos o inactivos)}
\centering
\begin{tabular}[t]{l|r|r}
\hline
