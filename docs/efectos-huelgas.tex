...
\caption{\label{tab:unnamed-chunk-16}Frecuencia de respuestas 'Movimiento social de apoyo a demandas laborales'}
\centering
...
\caption{\label{tab:unnamed-chunk-20}Frecuencias de 'Grado de acuerdo: Posición opuesta entre el movimiento y las autoridades' por ola}
\centering
...
\caption{\label{tab:unnamed-chunk-21}Frecuencias de 'Frecuencia: Participación en el movimiento' por ola}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
...
\caption{\label{tab:unnamed-chunk-22}Frecuencias de cada categoría de Membresía Sindicatos por ola considerando toda la muestra}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
...
\caption{\label{tab:unnamed-chunk-23}Frecuencias de Membresía Sindicato por ola, para quienes valoran movimientos laborales}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
mem\_sindicato & Ola\_1 & Ola\_3 & Ola\_5\\
...
\caption{\label{tab:unnamed-chunk-24}Frecuencias de cada categoría de Participación en huelga por ola considerando toda la muestra}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
...
\caption{\label{tab:unnamed-chunk-25}Frecuencias de Participación en huelga por ola, para quienes valoran movimientos laborales}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
part\_huelga & Ola\_1 & Ola\_3 & Ola\_5\\
...
\caption{\label{tab:unnamed-chunk-26}Frecuencias de Participación en huelga por ola, para quienes son miembros de sindicatos (activos o inactivos)}
\centering
...
\caption{\label{tab:unnamed-chunk-27}Frecuencias de cada categoría de Interés en la política por ola considerando toda la muestra}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
...
\caption{\label{tab:unnamed-chunk-28}Frecuencias de Interés en la política por ola, para quienes valoran movimientos laborales}
\centering
\begin{tabular}[t]{l|r|r|r}
\hline
int\_politica & Ola\_1 & Ola\_3 & Ola\_5\\
...
\caption{\label{tab:unnamed-chunk-29}Frecuencias de Interés en la política por ola, para quienes son miembros de sindicatos (activos o inactivos)}
\centering
\begin{tabular}[t]{l|r|r}
\hline
